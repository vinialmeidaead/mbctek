...
const CurriculumSection = () => {
  ...
  const achievements = [
    "Atuou no Sicoob CCS (EPPC/EGPC) de 2022 a 2023, realizando mentorias técnicas para diversas áreas de negócios do CCS e ministrou este curso por vídeo chamada em 2023 para todas as Centrais, Cooperativas e PA´s com apoio e acompanhamento da Universidade Corporativa.",
