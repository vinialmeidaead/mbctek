...
const EnhancedDarkLandingPageHeader = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center text-white w-full relative overflow-hidden"
         style={{
      ...
      {[...Array(5)].map((_, index) => (
        <motion.div
          ...
          style={{
            background: 'radial-gradient(circle, rgba(46,125,50,0.8) 0%, rgba(46,125,50,0) 70%)',
      ...
      <div className="max-w-4xl text-center p-6 relative z-10">
        ...
        >
          Curso Prático IBM Cognos Analysis Studio (Analítico): De Iniciante a Expert
        </motion.h1>
        ...
        >
          Prepare-se para liderar projetos de Business Intelligence com um dos softwares mais poderosos do mercado mundial. Surpreenda-se com o poder analítico e de tomada de decisão que você receberá após a conclusão deste curso de capacitação. Voe mais alto!
        </motion.p>
      ...
      <motion.div
        ...
        style={{
          background: 'radial-gradient(circle, rgba(253,216,53,0.1) 0%, rgba(253,216,53,0) 70%)',
